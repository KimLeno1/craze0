    ...
    <div className="space-y-12 animate-in fade-in duration-500">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-4">
          <div className="glass px-6 py-2 rounded-xl border-white/5 flex items-center gap-3">
             ...
             <span className="text-[10px] font-black uppercase tracking-widest text-[#00D1FF]">System Link Active</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-6">
        {orders.map(order => (
          <div 
            key={order.id} 
            className={`glass p-8 rounded-[2.5rem] border transition-all duration-500 ${selectedOrder?.id === order.id ? 'border-[#00D1FF]/50 bg-zinc-900/40' : 'border-white/5 hover:border-white/20'}`}
          >
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <span className={`px-3 py-1 rounded-full text-[8px] font-black uppercase tracking-widest ${
                    ...
                    order.status === OrderStatus.SHIPPED ? 'bg-[#00D1FF]/10 text-[#00D1FF]' :
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <input 
                      ...
                      className="w-full bg-black/40 border border-white/5 px-6 py-4 rounded-2xl text-xs font-mono text-white focus:border-[#00D1FF] transition-all outline-none"
                    />
                  </div>
