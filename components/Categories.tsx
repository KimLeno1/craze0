...
const Categories: React.FC<CategoriesProps> = ({ onSelectCategory, onNavigate }) => {
  return (
    <div className="p-8 space-y-12 animate-in fade-in duration-500 pb-32">
      <header>
        <h1 className="text-5xl font-serif italic text-white">The <span className="text-[#1a73e8] not-italic font-sans font-black">SECTORS</span></h1>
      ...
      <div className="grid grid-cols-1 gap-6">
        {CATEGORY_DATA.map((cat) => (
          <div 
            ...
            className="group relative h-48 rounded-[2.5rem] overflow-hidden cursor-pointer border border-white/5 hover:border-[#1a73e8]/30 transition-all"
          >
            ...
            <div className="absolute inset-0 p-10 flex items-center justify-between">
              <div className="space-y-2">
                ...
                <p className="text-[8px] font-black uppercase tracking-widest text-[#1a73e8]">Access Authorized</p>
              </div>
