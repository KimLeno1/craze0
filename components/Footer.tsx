    ...
    <footer className="bg-black text-white px-6 md:px-12 py-24 border-t border-white/5">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-16 md:gap-8">
        <div className="md:col-span-2">
          <h2 className="text-4xl font-serif italic mb-8">CLOSET<span className="text-[#1a73e8] font-sans not-italic font-black">KRAZE</span></h2>
          ...
          <div className="flex gap-10">
            <span className="text-[10px] uppercase tracking-[0.3em] font-black text-zinc-600 hover:text-[#1a73e8] cursor-pointer transition-colors">IG // Archives</span>
            <span className="text-[10px] uppercase tracking-[0.3em] font-black text-zinc-600 hover:text-[#1a73e8] cursor-pointer transition-colors">Terminal</span>
            <span className="text-[10px] uppercase tracking-[0.3em] font-black text-zinc-600 hover:text-[#1a73e8] cursor-pointer transition-colors">Discord</span>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="relative">
            <input 
              ...
              className="w-full bg-zinc-900 border border-white/5 px-6 py-4 text-[10px] font-black focus:outline-none focus:border-[#1a73e8] transition-colors rounded-xl"
            />
            <button className="absolute right-4 top-1/2 -translate-y-1/2 text-[10px] uppercase tracking-widest font-black text-[#1a73e8]">Sync</button>
          </div>
        </div>
      </div>
