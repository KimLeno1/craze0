        ...
        <header className="p-8 md:p-12 border-b border-white/5 flex justify-between items-center bg-black/40">
           <div className="space-y-2">
              <div className="flex items-center gap-3">
                 ...
                 <span className="text-[10px] font-black text-[#EC4899] uppercase tracking-[0.4em]">Acquisition Summary</span>
              </div>
        ...
        <div className="flex-1 overflow-y-auto p-8 md:p-12 space-y-12 scrollbar-hide">
           ...
           <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-6">
                 <div className="text-[10px] font-black text-[#EC4899] uppercase tracking-widest border-l-2 border-[#EC4899] pl-4">Logistics Protocol</div>
              ...
              <div className="space-y-6">
                 <div className="text-[10px] font-black text-[#EC4899] uppercase tracking-widest border-l-2 border-[#EC4899] pl-4">Acquisition Status</div>
                 <div className="bg-zinc-950 p-6 rounded-3xl border border-white/5 flex flex-col justify-center items-center text-center space-y-4 min-h-[160px]">
                    <span className={`px-6 py-2 rounded-full text-xs font-black uppercase tracking-widest shadow-2xl ${
                      ...
                      'bg-[#EC4899]/10 text-[#EC4899] border border-[#EC4899]/30 animate-pulse'
                    }`}>
                      {order.status}
                    </span>
                 ...
                 {order.items.map((item, idx) => (
                    <div key={idx} className="flex gap-6 items-center bg-zinc-950/40 p-4 rounded-[2rem] border border-white/5 group hover:border-white/10 transition-all">
                       ...
                       <div className="flex-1 min-w-0">
                          <div className="text-[9px] font-black text-[#EC4899] uppercase tracking-widest mb-1">{item.isBundle ? 'Synergy Kit' : `Sector_${item.category}`}</div>
