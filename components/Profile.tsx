      ...
      <section className="space-y-8 md:space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-stretch">
          <div className="bg-zinc-950/40 p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] border border-white/5 space-y-6 md:space-y-8 flex flex-col justify-between">
            <div className="space-y-4">
              <div className="text-[9px] md:text-[10px] font-black text-[#EC4899] uppercase tracking-widest">Inject Promo Code</div>
              <div className="relative group">
                <input 
                  ...
                  className="w-full bg-black border border-white/10 p-5 md:p-6 rounded-2xl text-[10px] md:text-xs font-black text-white focus:border-[#EC4899] transition-all outline-none"
                />
                <button 
                  onClick={handlePromoActivate}
                  className="absolute right-2 md:right-3 top-1/2 -translate-y-1/2 bg-white text-black px-4 md:px-6 py-2 md:py-3 rounded-xl text-[8px] font-black uppercase tracking-widest hover:bg-[#EC4899] hover:text-white transition-all active:scale-95"
                >
                  Sync
                </button>
              </div>
          ...
          <div className="bg-zinc-950 p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] border border-white/5 relative overflow-hidden flex flex-col justify-center items-center text-center min-h-[160px]">
             {activePromo ? (
               <div className="animate-in zoom-in-95 duration-500 space-y-4">
                  <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-[#EC4899]/10 border border-[#EC4899]/30 flex items-center justify-center text-2xl md:text-3xl mx-auto animate-pulse">🎫</div>
                  <div className="space-y-1">
                    <div className="text-[8px] md:text-[9px] font-black text-[#EC4899] uppercase tracking-widest">Active Influence</div>
